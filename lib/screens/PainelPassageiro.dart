...
class _PainelPassageiroState extends State<PainelPassageiro> {
  ...
  String _textoBotao = "Llama a uber";
    ...
    if (enderecoDestino.isNotEmpty) {
      ...
      if (listaEnderecos != null && listaEnderecos.length > 0) {
        ...
        showDialog(
            ...
            builder: (contex) {
              return AlertDialog(
                title: Text("Verificación de dirección"),
  ...
  _statusUberNaoChamado() {
    ...
    _alterarBotaoPrincipal("Llama a uber", Colors.black, () {
      _chamarUber();
    });
